This directory contains more C programs on Pointers and arrays
...
6. 5-string_touper.c:  a function that changes all lowercase letters of a string to uppercase.
...
You are not allowed to use any ternary operation:L
